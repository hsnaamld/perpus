...
<body>
    <div class="container">
        <div class="content">
            <div class="card rounded border-danger shadow" style="margin-top:8rem">
                <div class="row">
                    ...
                    <div class="col mb-4" style="margin-left:4rem; margin-right:4rem">
                        ...
                        <form method="post" action="aksi/proses_daftar.php">
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-danger" style="margin-top:3rem;">Register</button>
                            </div>
                            <p class="mt-3">Sudah punya akun? <a href="index.php" class="btn btn-outline-danger">Login</a></p>
                        </form>
                    </div>
                </div>
            </div>
